...
type ColorVariant = "emerald" | "purple" | "orange" | "cyan";
...
interface GradientButtonProps
  ...
  /** Renders a semantic link (e.g. in-page anchor or Calendly URL) */
  href?: string;
  rel?: string;
  target?: string;
}
...
const gradientColors: Record<ColorVariant, GradientColors> = {
  ...
  cyan: {
    dark: {
      border: "from-[#0891b2] via-[#0c4a6e] to-[#06b6d4]",
      overlay: "from-[#06b6d4]/40 via-[#0C1F21] to-[#0891b2]/30",
      accent: "from-[#67e8f9]/10 via-[#0C1F21] to-[#164e63]/50",
      text: "from-[#a5f3fc] to-[#06b6d4]",
      glow: "rgba(6,182,212,0.15)",
      textGlow: "rgba(6,182,212,0.45)",
      hover: "from-[#164e63]/20 via-[#06b6d4]/10 to-[#164e63]/20",
    },
    light: {
      ...
      text: "from-cyan-700 to-cyan-600",
      glow: "rgba(6,182,212,0.2)",
      hover: "from-cyan-300/30 via-cyan-200/20 to-cyan-300/30",
    },
  },
};
...
export default function GradientButton({
  ...
  const shellClass = cn(
    "group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-lg px-6 transition-all duration-500",
  ...
  return (
    <Button className={shellClass} variant="ghost" {...props}>
      {inner}
    </Button>
  );
}
